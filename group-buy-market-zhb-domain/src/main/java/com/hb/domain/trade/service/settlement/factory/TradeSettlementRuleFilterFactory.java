package com.hb.domain.trade.service.settlement.factory;
...
import com.hb.domain.trade.service.settlement.filter.EndRuleFilter;
import com.hb.domain.trade.service.settlement.filter.OutTradeNoRuleFilter;
import com.hb.domain.trade.service.settlement.filter.SCRuleFilter;
import com.hb.domain.trade.service.settlement.filter.SettableRuleFilter;
...
public class TradeSettlementRuleFilterFactory {
    ...
    public BusinessLinkedList<TradeSettlementRuleCommandEntity,
        ...
        // 组装链
        LinkArmory<TradeSettlementRuleCommandEntity, TradeSettlementRuleFilterFactory.DynamicContext, TradeSettlementRuleFilterBackEntity> linkArmory = new LinkArmory<>("交易结算规则过滤链", scRuleFilter, outTradeNoRuleFilter, settableRuleFilter, endRuleFilter);
