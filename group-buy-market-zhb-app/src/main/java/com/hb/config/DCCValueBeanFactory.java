...
/**
 * 基于 Redis 实现动态配置中心
 * DCCValueBeanFactory 实现了 BeanPostProcessor，这样我们就可以拿到 Spring 所有实例化后的 Bean 对象。Spring 是扫描你工程下所有的 Bean 对象，加载到它的容器里管理。
 */
...
public class DCCValueBeanFactory implements BeanPostProcessor {
    ...
    public RTopic testRedisTopicListener(RedissonClient redissonClient) {
        RTopic topic = redissonClient.getTopic(BASE_CONFIG_PATH);
